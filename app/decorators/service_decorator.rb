class ServiceDecorator
  ...
  def service_preview_img_thumbnail
    if service.preview_img.attached?
      view_context.image_tag service.preview_img.variant(combine_options: {thumbnail: "360X360^", gravity: "center", extent: "360x225"}).processed, class: 'card-img-top box-shadow', alt: "Thumbnail [360x225]"
    else
