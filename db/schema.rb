...
ActiveRecord::Schema.define(version: 2018_08_23_151912) do
  ...
  create_table "services", force: :cascade do |t|
    t.string "title", default: "Service title", null: false
    t.string "preview", default: "Service preview", null: false
