...
ActiveRecord::Schema.define(version: 2018_12_27_004102) do
  ...
  create_table "countries", force: :cascade do |t|
    t.string "name", default: "No translation", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "description", default: "No translation", null: false
  end
